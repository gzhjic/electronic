...
// #define NRF24L01_MISO          PB3  //输入0 		//数据输出
#define   Hign_24L01_MISO    PORTB |= (1 << PB3)  
#define   Low_24L01_MISO     PORTB &= ~(1 << PB3) 
#define   Read_24L01_MISO    PINB & (1 << PB3)    
//#define NRF24L01_MOSI         PB4       //输出1 //数据输入
#define   Hign_24L01_MOSI    PORTB |= (1 << PB4)  
#define   Low_24L01_MOSI     PORTB &= ~(1 << PB4)
#define   Read_24L01_MOSI	 PINB  & (1<<PB4)
...
#define   Low_24L01_CSN     PORTB &= ~(1 << PB6) 
#define   Hign_24L01_CSN    PORTB |= (1 << PB6) 
//#define NRF24L01_CE         PB1       //输出1	//收发模式选择端
#define   Hign_24L01_CE    PORTB |= (1 << PB7) 
#define   Low_24L01_CE     PORTB &= ~(1 << PB7)  
