 #ifndef _shounrf24l01_h_
 #define _shounrf24l01_h_
...
extern char SPI_RW(char data);
extern char SPI_Read(char reg);
extern char SPI_RW_Reg(char reg, char value); 
extern char SPI_Read_Buf(char reg, char *pBuf, char uchars); 
extern char SPI_Write_Buf(char reg, char *pBuf, char uchars); 
extern void SetRX_Mode(void); 
extern char nRF24L01_RxPacket(char* rx_buf); 
extern void nRF24L01_TxPacket(char * tx_buf); 
